...
class Solution {
    ...
    private boolean hasCycleBFS(int start, List<List<Integer>> adj, boolean[] visited) {
        Queue<Pair> queue = new LinkedList<>();
        queue.offer(new Pair(start, -1)); // Start with no parent
        visited[start] = true;
        ...
        while (!queue.isEmpty()) {
            ...
            for (int neighbor : adj.get(node)) {
                ...
                // If neighbor is parent, ignore (the edge we came from)
            }
        }
     ...
     public static void main(String[] args){
        ...
        // Test case 7: Simple cycle (edge case)
        int numCourses7 = 2;
        int[][] prerequisites7 = {{0,1}};
        System.out.println("\n=== Test 7: Single Edge ===");
        System.out.println("Courses: " + numCourses7);
        System.out.println("Prerequisites (as undirected): [[0,1]]");
        System.out.println("Can Finish: " + sol.canFinish(numCourses7, prerequisites7)); // Expected: true
    }
}
